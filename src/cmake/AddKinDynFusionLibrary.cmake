...
function(add_kindynfusion_library)
  ...
  if(is_interface)
    ...
    install(FILES ${public_headers} DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/KinDynFusion/${installation_folder}")
    install(FILES ${private_headers} DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/KinDynFusion/${installation_folder}/impl")
    ...
    install(TARGETS    ${name}
      ...
      PUBLIC_HEADER    DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/KinDynFusion/${installation_folder}"       COMPONENT dev
      PRIVATE_HEADER   DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/KinDynFusion/${installation_folder}/impl"  COMPONENT dev)
  ...
  foreach(header ${public_headers})
    ...
    if ((extension STREQUAL ".h") OR (extension STREQUAL ".hpp"))
      ...
      set(include_command "#include <KinDynFusion/${installation_folder}/${header_name}>")
  ...
  # add alias
  add_library(KinDynFusion::${name} ALIAS ${name})
  ...
  set_property(GLOBAL APPEND PROPERTY KinDynFusion_TARGETS ${name})
