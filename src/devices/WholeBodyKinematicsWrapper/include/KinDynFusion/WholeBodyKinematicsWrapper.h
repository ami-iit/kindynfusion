/**
 * @file WholeBodyKinematicsWrapper.h
...
class WholeBodyKinematicsWrapper : public yarp::dev::DeviceDriver,
                                   public yarp::dev::IMultipleWrapper,
                                   public yarp::os::PeriodicThread
{
public:
    WholeBodyKinematicsWrapper(double period,
                              yarp::os::ShouldUseSystemClock useSystemClock
                              = yarp::os::ShouldUseSystemClock::No);
    WholeBodyKinematicsWrapper();
    ~WholeBodyKinematicsWrapper();
